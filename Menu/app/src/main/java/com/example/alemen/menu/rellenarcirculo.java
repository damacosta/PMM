...
public class rellenarcirculo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rellenarcirculo);
    ...
    public boolean onContextItemSelected(MenuItem itemMnuContex) {
        ...
        switch (itemMnuContex.getItemId()) {
            ...
            case R.id.CtxLblOpc2:
                toast("VACIADO");
                Intent cuadrado = new Intent(this, circulo.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.SubMnuOpc1:
                Intent rectangulo = new Intent(rellenarcirculo.this, cuadrado.class);
                startActivity(rectangulo);
                return true;
            case R.id.SubMnuOpc2:
                Intent circulo = new Intent(rellenarcirculo.this, circulo.class);
                startActivity(circulo);
                return true;
            case R.id.MnuOpc3:
                Intent informacion = new Intent(rellenarcirculo.this, info.class);
